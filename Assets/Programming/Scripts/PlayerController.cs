...
public class PlayerController : MonoBehaviour
{
    ...
    readonly float offFlameTrailTime = 0.1f;
    ...
    void BoostAction()
    {
        if (inputBoost_Pressed)
        {
            ...
            else
            {
                ...
                Debug.Log("Flame Ring Input Disabled");
            }
        }
    ...
    public void InputBrake(InputAction.CallbackContext floatInput)
    {
        inputBrake = floatInput.ReadValue<float>();
    }
